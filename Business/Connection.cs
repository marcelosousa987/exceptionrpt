...
namespace CadMaterial.Business
{
    ...
    class Connection
    {
        ...
        public static String conDatabase; // Valor estático para receber o endereço da conexão

        public static void setConDatabase(String setValue)
        {
            conDatabase = "BRSPVWDB1";
        }

        public Connection() // Parametro opcional - permitir que selecione o tipo do SELECT
        {
            this.connString = "Driver={IBM DB2 ODBC DRIVER};hostname=" + conDatabase + ";" +
        ...
        public bool updateTable(String dbTable, String sqlSet, String sqlWhere)
        {
            ...
            DialogResult result = MessageBox.Show("Você está a ponto de realizar um UPDATE no banco de dados\n\n" + updateClause +
                "\n\nDeseja continuar? ", "Nota",MessageBoxButtons.YesNo, MessageBoxIcon.Exclamation);
